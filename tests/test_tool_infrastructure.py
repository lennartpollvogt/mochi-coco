...
class TestToolSchema:
    ...
    def test_get_tool_descriptions(self):
        ...
        descriptions = service.get_tool_descriptions({
            'with_desc': tool_with_desc,
            'without_desc': tool_without_desc
        })
...
class TestToolConfig:
    ...
    def test_backward_compatibility_property(self):
        ...
        settings_confirm = ToolSettings(execution_policy=ToolExecutionPolicy.ALWAYS_CONFIRM)
        settings_no_confirm = ToolSettings(execution_policy=ToolExecutionPolicy.NEVER_CONFIRM)

        assert settings_confirm.confirmation_necessary == True
        assert settings_no_confirm.confirmation_necessary == False
...
class TestToolSelectionUI:
    ...
    @patch('mochi_coco.ui.user_interaction.UserInteraction')
    @patch('mochi_coco.ui.tool_selection_ui.Console')
    def test_get_tool_selection_invalid_input_retry(self, mock_console_class, mock_user_interaction_class):
