...
- 📝 **System Prompts** - Place `*.md` or `*.txt` files in the `system_prompts` folder within the root directory of the terminal and them for chat sessions.
...
│ │ 2   │ llama3.2:latest           │       1925.8 │ llama           │   131072 │  Yes  │                    ││ │ 3   │ qwen3-coder:latest        │      17697.0 │ qwen3moe        │   262144 │  No   │                    │
