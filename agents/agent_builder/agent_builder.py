"""
Agent builder tools for creating new agents in the mochi-coco system.

This module provides tools for file system operations needed to create agents:
- Reading and writing files
- Editing files with precise line control
- Listing directory contents
- Deleting and renaming files

Note: Shell command execution is intentionally excluded as it's not needed for agent creation.
"""
